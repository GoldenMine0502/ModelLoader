...
public class ThreeByThreeBlock extends BaseHorizontalBlock {
    ...
    private static final VoxelShape SHAPE_N = java.util.Optional.of(Block.makeCuboidShape(-16, -16, 0, 32, 32, 16)).get();

    private static final VoxelShape SHAPE_W = java.util.Optional.of(Block.makeCuboidShape(0, -16, -16, 16, 32, 32)).get();
